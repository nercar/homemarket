	...
	<body class="hold-transition login-page" onload="document.getElementById('tusuario').focus()" oncontextmenu="return false">
		<div class="wrapper">
			...
			<nav class="navbar navbar-expand border-bottom navbar-dark bg-dark elevation-2">
				...
				<h2 id="titulo" class="align-items-center ml-2"><?php echo substr($titulo, strpos($titulo, '#')); ?><sup>v.Beta</sup></h2>
			</nav>
			<!-- /.navbar -->
			...
			<div class="login-box">
				...
				<div class="card elevation-4">
					...
					<div class="card-body login-card-body">
						<form action="app/controller/IniciarSesion.php" method="post" onsubmit="document.getElementById('tclave').value = ascii_to_hexa(document.getElementById('tclave').value)">
